        ...
        <div className="card bg-transparent border-0 text-light">
          ...
          <ul className="list-group list-group-flush">
            <li className="list-group-item border-0 text-light bg-dark">
             <MdLocationOn className="me2 /"></MdLocationOn> 329 WASHINGTON ST BOSTON, MA
              02108
            </li>
            <li className="list-group-item border-0 text-light bg-dark">
              {" "}
              <MdRingVolume className="me2 /"></MdRingVolume> (617) 557-0089
            </li>
            <li className="list-group-item text-light bg-dark">
            <MdEmail className="me2 /"></MdEmail> contact@example.com
            </li>
          </ul>
